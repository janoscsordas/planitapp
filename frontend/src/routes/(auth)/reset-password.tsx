  ...
  return (
    <main className="min-h-svh flex items-center justify-center bg-background px-4">
      ...
      <div className="w-80 bg-background-alt">
        ...
        <p className="text-center text-muted-foreground text-sm mb-8 mt-2">Itt tudod megváltoztatni a jelszavad</p>
        <form onSubmit={(e) => {
          e.preventDefault()
          form.handleSubmit()
        }}
        id="reset-password-form">
          <FieldGroup>
            ...
            <form.Field
              ...
              children={(field) => (
                <Field>
                  <FieldLabel htmlFor={field.name}>Új jelszó megerősítése</FieldLabel>
                  <Input
                    id={field.name}
                    name={field.name}
                    value={field.state.value}
            ...
            <form.Subscribe 
              ...
              children={([, isSubmitting]) => (
                <Field orientation="horizontal">
                  <Button className="w-full cursor-pointer" type="submit" form="reset-password-form" disabled={isSubmitting}>
          ...
          <p className="text-center text-muted-foreground text-xs mt-4">*A jelszó megváltoztatása után mindenhonnan kijelentkeztetünk.</p>
        </form>
      </div>
    </main>
  )
