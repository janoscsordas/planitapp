...
function RouteComponent() {
  ...
  const progress =
    ((TIMER_DURATION_MS - timeLeft * 1000) / TIMER_DURATION_MS) * 100;
        ...
        <div className="space-y-2">
          ...
          <CardDescription className="text-muted-foreground text-balance">
            {resent ? (
              ...
              <div className="space-y-2">
                <p>
                  Úgy tűnik, korábban már regisztráltál a(z){" "}
                  <span className="font-medium text-foreground">{email}</span>{" "}
                  címmel, de még nem aktiváltad a fiókodat.
                </p>
              ...
              <>
                ...
                <span className="font-medium text-foreground">{email}</span>{" "}
                címre. Kattints rá a fiókod aktiválásához.
              </>
            )}
          </CardDescription>
        </div>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3 bg-muted/30 p-4 rounded-lg">
          <div className="flex items-center justify-between text-sm font-medium">
            ...
            <span
              className={`font-mono ${timeLeft <= 60 ? "text-destructive animate-pulse" : "text-primary"}`}
            >
              {formatTime(timeLeft)}
            </span>
          </div>
        ...
        <div className="space-y-3">
          ...
          >
            {isResending ? (
              ...
              <>
                <IconRefresh
                  className={`w-4 h-4 mr-2 ${!canResend && "opacity-50"}`}
                />
                Email újraküldése
              </>
            )}
        ...
        <div className="pt-4 border-t text-center">
          <p className="text-xs text-muted-foreground leading-relaxed">
            Nem találod? Nézd meg a{" "}
            <span className="font-medium text-foreground">Spam</span> mappát is,
